<%@ Page Title="" Language="C#" MasterPageFile="Client.master" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Admin_User" %>
                ...
                <hr />                                  
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <asp:TextBox runat="server" ID="pass" onClick="showDesc();"  CssClass="form-control" style="max-width:480px !important; " MaxLength="12" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <asp:TextBox runat="server"  ID="passwordRe"   CssClass="form-control" style="max-width:480px !important; " />
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            ...
                            <asp:Button runat="server"  Text="Update" OnClientClick="if ( Page_ClientValidate() ) {hide();}"   OnClick="Update_Click" CssClass="btn btn-default" style="float: right; margin-left:5px;" ID="btnSave" />
                            <asp:Button runat="server"  Text="< Back" OnClick="Back_Click"   CssClass="btn btn-warning" style="float: right" ID="Button1" />
                        </div>
                    </div>
