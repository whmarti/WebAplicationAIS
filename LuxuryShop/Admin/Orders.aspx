<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Manager.master" AutoEventWireup="true" CodeFile="Orders.aspx.cs" Inherits="Admin_Orders" %>
      ...
      <div style="display:flex;align-items: center;">
       <div class="row container  " style="align-items: center;display: flex;">
              <div class="col-3 pt-1 " style="flex:2 1 auto; ">
                  <h3 style="color:white;">  Orders for many times</h3>                  
              </div>
              <div class="col-5 text-center" style="flex:2 1 auto;"> <h3 class="text-center" >Client Orders</h3> <p>( <% if ( numRows!="0"){ %><%=numRows %><%}%> )</p> </div>
