<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Manager.master" AutoEventWireup="true" CodeFile="Login1.aspx.cs" Inherits="Admin_Login" %>
               ...
               <h4>Login</h4>
                <hr />                
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10"><asp:HyperLink ID="lkForgot" runat="server">Forgot the password?</asp:HyperLink>
