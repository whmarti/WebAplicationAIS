...
public partial class Admin_Users : System.Web.UI.Page
{
    ...
    public System.Collections.Generic.List<Entity.User> lst_TopVisitors;
    ...
    /// with the information.
    /// </summary>
    protected void FillDataVisitors()
    {
        userBL = new UserBL();
        lst_TopVisitors = userBL.getTopVisitorsBL(topVisitors, "","", ref mError);
        //ViewState["lst_TopVisitors"] = lst_TopVisitors;
    }
    ...
    public static Object WebM_VisitorsByDate(String pTopVisitors, String pFecFrom, String pFecTo)
    {
        int _showErr = Convert.ToInt32(ConfigurationManager.AppSettings["DataBaseErr"]);        
        mError _mError = new mError("", "");
        String _msg = "Top visitors updated.";
        Boolean _success = false;
        System.Collections.Generic.List<Entity.User> _lst_TopVisitors = null;


        try
        {
            if (pFecFrom != "" && pFecTo != "" && pTopVisitors != "")
            {

                UserBL _userBL = new UserBL();
                _lst_TopVisitors = _userBL.getTopVisitorsBL(pTopVisitors, pFecFrom, pFecTo, ref _mError);
                _success = true;
        ...
        return new { success = _success, model = JsonConvert.SerializeObject(_lst_TopVisitors), msg = _msg };
    }
