...
public partial class Admin_Orders : System.Web.UI.Page
{
    ...
    public String numRows = "0", legendSearch = "# Order, Client name...";
    ...
    protected void FillData()
    {
        ...
        if (_search == legendSearch)
            _search = "";
        System.Collections.Generic.List<Order> _dt = txtSearch.Text == "" ? orderBL.getOrdersBL(null,ref mError) : orderBL.getOrderSearch_BL(null, _search, ref mError);
        if (_dt != null)
        {
            if (_dt.Count > 0)
            {
    ...
    protected void Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            orderBL = new OrderBL();
            System.Collections.Generic.List<Order> _dt = orderBL.getOrderSearch_BL(null,txtSearch.Text, ref mError);
            if (_dt != null)
            {
                if (_dt.Count > 0)
                {
